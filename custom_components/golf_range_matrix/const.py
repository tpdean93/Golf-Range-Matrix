...
METRIC_FIELDS: dict[str, dict[str, str | tuple[str, ...] | int]] = {
    ...
    "smash_factor": {"name": "Smash Factor", "unit": "", "icon": "mdi:flash", "decimals": 1, "aliases": ("smash_factor", "golf_smash_factor", "smashFactor")},
    ...
    "total_spin": {"name": "Total Spin", "unit": "rpm", "icon": "mdi:rotate-right", "decimals": 1, "aliases": ("total_spin", "golf_total_spin", "totalSpin")},
    "spin_axis": {"name": "Spin Axis", "unit": "deg", "icon": "mdi:axis-arrow", "decimals": 1, "aliases": ("spin_axis", "golf_spin_axis", "spinAxis")},
    "backspin": {"name": "Backspin", "unit": "rpm", "icon": "mdi:rotate-right", "decimals": 1, "aliases": ("backspin", "golf_backspin", "backSpin")},
    "sidespin": {"name": "Sidespin", "unit": "rpm", "icon": "mdi:rotate-3d-variant", "decimals": 1, "aliases": ("sidespin", "golf_sidespin", "sideSpin")},
